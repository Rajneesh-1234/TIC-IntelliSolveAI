...
const roles = [
  ...
  headline: "Control & Manage",
  description: "Manage users, monitor platform activity, control listings, and oversee the entire system."
}
]
...
function LoginForm() {
  ...
  const { setRole, setIsAuthenticated, loginAsAdmin } = useAppStore()
...
const handleLogin = async (e: React.FormEvent) => {
  ...
  try {
     // ✅ 🔥 ADMIN DUMMY LOGIN (TOP PRIORITY)
    if (email === "admin@smartagri.com" && password === "admin123") {
      loginAsAdmin()   // Zustand function
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white w-full">
          <Link href="/" className="flex items-center gap-2 w-fit">
            <div className="flex size-6 items-center justify-center rounded-xl bg-white/20 backdrop-blur-sm">
